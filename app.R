...
index <- tribble(
  ...
  #---------
  "흡연", "현재흡연율","sm_a0100", NULL, 2011:2018, TRUE,2, 1,
  "흡연","남자현재흡연율","sm_a0100","sex_m", 2011:2018, TRUE,2, 1,
  "흡연","평생흡연율","sm_a0200",NULL, 2011:2018, TRUE,2,1,
  "흡연","흡연시작연령","sm_a0300", "sm_a0200", 2011:2018, FALSE,2, 2,
  "흡연","금연시도율","sm_d0600","sm_a0100", 2011:2018, FALSE,1, 1,
  "흡연","현재 비흡연자의 직장실내간접흡연노출률","sm_c0800","sm_e0200", c(2011,2013:2018), FALSE,2, 1,
  "음주","월간음주율","dr_a0400",NULL, 2011:2018, TRUE,2, 1,
  "음주","고위험음주율","dr_a0500",NULL, 2011:2018, TRUE,2, 1,
  "안전의식","운전시 안전벨트 착용률","sf_a0100","sfa_01z1", 2011:2018, TRUE,1, 1,
  "안전의식","동승자 안전벨트 착용률","sf_a0400","sf_a0300", 2011:2018, TRUE,1, 1,
  "안전의식", "음주운전 경험률", "sf_b0500","sf_b0400", 2011:2018, FALSE,2, 1,
  "운동 및 신체활동","중등도이상 신체활동 실천율","ph_a0500",NULL, 2011:2017, TRUE,1, 1,
  "운동 및 신체활동", "걷기 실천율", "ph_b0200", NULL, 2011:2018, TRUE,1, 1,
  "비만 및 체중조절", "비만율", "ob_a0203", NULL, 2011:2018, TRUE,2, 1,
  "비만 및 체중조절", "체중조절 시도율", "ob_b0100", NULL, 2011:2018, TRUE,1, 1,
  "비만 및 체중조절", "주관적 비만 인지율", "ob_a0300", NULL, 2011:2018, TRUE,2, 1,
  "식생활", "저염선호율(type1)", "nu_b0400", NULL, 2011:2018, TRUE,1, 1,
  "식생활", "저염선호율(type2)", "nu_b0500", NULL, 2011:2018, TRUE,1, 1,
  "식생활", "저염선호율(type3)", "nu_b0600", NULL, 2011:2018, TRUE,1, 1,
  "식생활", "영양표시독해율","nu_c0300",NULL, 2014:2018, FALSE,1, 1,
  "식생활", "5일 이상 아침식사 실천율","nu_a0204",NULL, 2011:2018, TRUE,1, 1,
  "구강건강", "저작불편 호소율", "or_b0100", "age65", 2011:2018, FALSE,2, 1,
  "구강건강", "구강검진 수진율", "or_e0500", NULL, 2011:2018, TRUE,1, 1,
  "구강건강", "점심식사후 칫솔질 실천율", "or_d0100", "or_d0050", 2011:2018, TRUE,1, 1,
  "정신건강", "스트레스 인지율", "mt_a0100", NULL, 2011:2018, TRUE,2, 1,
  "정신건강", "우울감 경험률", "mt_b0100", NULL, 2011:2018, TRUE,2, 1,
  "예방접종", "인플루엔자 예방접종률", "sc_a0100", NULL, 2011:2018, TRUE,1, 1,
  "이환_고혈압", "혈압인지율","il_a1900", NULL, c(2011,2013:2018), TRUE,1, 1,
  "이환_고혈압","고혈압 의사진단경험률(30세이상)","il_a0200","age30", 2011:2018, TRUE,2, 1,
  "이환_고혈압","고혈압 약물치료율(30세이상)","il_a0500",list("age30","il_a0200"), 2011:2018, FALSE,1, 1,
  "이환_당뇨병","혈당인지율","il_b1900",NULL, c(2011,2013:2018), TRUE,1, 1,
  "이환_당뇨병","당뇨병 의사진단경험률(30세이상)","il_b0200","age30", 2011:2018, TRUE,2, 1,
  "이환_당뇨병","당뇨병 치료율(30세이상)","il_b0600",list("age30","il_b0200"), 2011:2018, FALSE,1, 1,
  "이환_당뇨병","당뇨병 안질환 합병증검사 수진율(30세이상)","il_b0900",list("age30","il_b0200"), 2011:2018, FALSE,1, 1,
  "이환_당뇨병","당뇨병 신장질환 합병증검사 수진율(30세이상)","il_b1000",list("age30","il_b0200"), 2011:2018, FALSE,1, 1,
  "이환_이상지질혈증","이상지질혈증 의사진단경험률(30세이상)","il_r0100","age30", 2011:2018, TRUE,2, 1,
  "이환_관절염","관절염 의사진단경험률(50세이상)","il_g0100","age50", 2011:2018, FALSE,2, 1,
  "의료이용","필요의료서비스 미치료율","sr_a0100", NULL, 2012:2018, TRUE,2, 1,
  "활동제한 및 삶의 질","양호한 주관적건강 인지율","ql_a0100",NULL, 2011:2018, TRUE,1, 1,
  "보건기관 이용","보건기관 이용률","ct_a0100",NULL, 2011:2018, TRUE,1, 1
)
...
server <- function(input, output) {
  ...
  table1 <- reactive({
    req(input$data1)
    req(input$year1)
    data3_vector = c(FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE)
    names(data3_vector) <- as.character(2011:2018)
    data3_value <- data3_vector[input$year1]
    data <- data_coding(dataread_chs_raw(year = input$year1, 
                                         filename = input$data1$datapath, data3 = data3_value), 
                        year = input$year1) %>%
  ...
  table2 <- reactive({
    ...
    data3_vector = c(FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE)
    names(data3_vector) <- as.character(2011:2018)
    data3_value <- data3_vector[input$year2]
    data <- data_coding(dataread_chs_raw(year = input$year2, 
                                         filename = input$data2$datapath, data3 = data3_value), 
                        year = input$year2) %>%
      select(com_va, indi_va, analy_va)
    return(data)
  })
  ...
  table3 <- reactive({
    ...
    data3_vector = c(FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE)
    names(data3_vector) <- as.character(2011:2018)
    data3_value <- data3_vector[input$year3]
    data <- data_coding(dataread_chs_raw(year = input$year3, 
                                         filename = input$data3$datapath, data3 = data3_value), 
                        year = input$year3) %>%
      select(com_va, indi_va, analy_va)
    return(data)
  }) 
  ...
  table4 <- reactive({
    ...
    data3_vector = c(FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE)
    names(data3_vector) <- as.character(2011:2018)
    data3_value <- data3_vector[input$year4]
    data <- data_coding(dataread_chs_raw(year = input$year4, 
                                         filename = input$data4$datapath, data3 = data3_value), 
                        year = input$year4) %>%
      select(com_va, indi_va, analy_va)
    return(data)
  }) 
  ...
  output$table3 <- DT::renderDataTable(DT::datatable({
    req(input$district_var)
    data_set <<- code_district_daegu(data_set)
    return(data_set)
    }))
